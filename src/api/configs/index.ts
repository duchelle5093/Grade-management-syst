...
import { StudentRevendicationService } from '../services/student-revendication.service';
...
export const teacherGradeService = new TeacherGradeService(apiGatewayClient);
export const studentRevendicationService = new StudentRevendicationService(apiGatewayClient);
